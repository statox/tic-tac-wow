<script lang="ts">
    import { getNewGame, type BoardPosition, type PlayerHand } from '../../services/gobblet';
    import { getGameCurrentHand, getGameOtherHand } from '../../services/gobblet/helpers';
    ...
    import {
        ...
        selectCellInBoard,
        selectPieceInHand
    } from '../../services/gobblet/state-machine';
