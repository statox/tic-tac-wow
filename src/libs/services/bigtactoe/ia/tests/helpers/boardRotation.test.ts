import { getNewBoard } from 'src/libs/services/bigtactoe';
import type { PlayerPieces } from 'src/libs/services/bigtactoe';
import {
    rotatePiecesClockwise,
    piecesAreEquivalent,
    boardAreEquivalent,
    rotateBoardClockwiseXtimes
} from 'src/libs/services/bigtactoe/ia/helpers';
