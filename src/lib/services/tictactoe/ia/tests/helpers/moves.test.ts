import { CENTER_INDEX, getNewBoard, makeMoveOnBoard } from '$lib/services/tictactoe';
import { Player } from '$lib/services/tictactoe';
import { getPossibleMoves, getUniquePossibleMoves } from '$lib/services/tictactoe/ia/helpers';
